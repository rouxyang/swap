...
class loader {
    ...
    protected static $swap_entities = [
        ...
        'swap\mysql_rdb_node'          => 'tech/repo/rdb/drivers/mysql.php',
        'swap\mysql_master_rdb_node'   => 'tech/repo/rdb/drivers/mysql.php',
        'swap\mysql_slave_rdb_node'    => 'tech/repo/rdb/drivers/mysql.php',
        'swap\mysql_rdb_conn'          => 'tech/repo/rdb/drivers/mysql.php',
        'swap\mysql_rdb_result'        => 'tech/repo/rdb/drivers/mysql.php',
        'swap\pgsql_rdb_node'          => 'tech/repo/rdb/drivers/pgsql.php',
        'swap\pgsql_master_rdb_node'   => 'tech/repo/rdb/drivers/pgsql.php',
        'swap\pgsql_slave_rdb_node'    => 'tech/repo/rdb/drivers/pgsql.php',
        'swap\pgsql_rdb_conn'          => 'tech/repo/rdb/drivers/pgsql.php',
        'swap\pgsql_rdb_result'        => 'tech/repo/rdb/drivers/pgsql.php',
        'swap\sqlite_rdb_node'         => 'tech/repo/rdb/drivers/sqlite.php',
        'swap\sqlite_master_rdb_node'  => 'tech/repo/rdb/drivers/sqlite.php',
        'swap\sqlite_slave_rdb_node'   => 'tech/repo/rdb/drivers/sqlite.php',
