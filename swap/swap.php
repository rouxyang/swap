...
class loader {
    ...
    protected static $swap_entities = [
        ...
        'swap\session'                 => 'server/session.php',
        'swap\session_manager'         => 'server/session.php',
        'swap\session_store'           => 'server/session.php',
        'swap\session_store_pool'      => 'server/session.php',
        'swap\memcached_session_store' => 'server/sess/memcached.php',
        'swap\redis_session_store'     => 'server/sess/redis.php',
        'swap\mysql_session_store'     => 'server/sess/mysql.php',
        'swap\pgsql_session_store'     => 'server/sess/pgsql.php',
        'swap\sqlite_session_store'    => 'server/sess/sqlite.php',
        ...
        'swap\mysql_rdb_node'          => 'tech/repo/rdb/databases/mysql.php',
        'swap\mysql_master_rdb_node'   => 'tech/repo/rdb/databases/mysql.php',
        'swap\mysql_slave_rdb_node'    => 'tech/repo/rdb/databases/mysql.php',
        'swap\mysql_rdb_conn'          => 'tech/repo/rdb/databases/mysql.php',
        'swap\mysql_rdb_result'        => 'tech/repo/rdb/databases/mysql.php',
        'swap\pgsql_rdb_node'          => 'tech/repo/rdb/databases/pgsql.php',
        'swap\pgsql_master_rdb_node'   => 'tech/repo/rdb/databases/pgsql.php',
        'swap\pgsql_slave_rdb_node'    => 'tech/repo/rdb/databases/pgsql.php',
        'swap\pgsql_rdb_conn'          => 'tech/repo/rdb/databases/pgsql.php',
        'swap\pgsql_rdb_result'        => 'tech/repo/rdb/databases/pgsql.php',
        'swap\sqlite_rdb_node'         => 'tech/repo/rdb/databases/sqlite.php',
        'swap\sqlite_master_rdb_node'  => 'tech/repo/rdb/databases/sqlite.php',
        'swap\sqlite_slave_rdb_node'   => 'tech/repo/rdb/databases/sqlite.php',
        'swap\sqlite_rdb_conn'         => 'tech/repo/rdb/databases/sqlite.php',
        'swap\sqlite_rdb_result'       => 'tech/repo/rdb/databases/sqlite.php',
