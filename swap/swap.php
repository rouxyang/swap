...
class loader {
    ...
    protected static $swap_entities = [
        ...
        'swap\mysql_rdb_node'          => 'tech/repo/rdb/mysql_rdb.php',
        'swap\mysql_master_rdb_node'   => 'tech/repo/rdb/mysql_rdb.php',
        'swap\mysql_slave_rdb_node'    => 'tech/repo/rdb/mysql_rdb.php',
        'swap\mysql_rdb_conn'          => 'tech/repo/rdb/mysql_rdb.php',
        'swap\mysql_rdb_result'        => 'tech/repo/rdb/mysql_rdb.php',
        'swap\pgsql_rdb_node'          => 'tech/repo/rdb/pgsql_rdb.php',
        'swap\pgsql_master_rdb_node'   => 'tech/repo/rdb/pgsql_rdb.php',
        'swap\pgsql_slave_rdb_node'    => 'tech/repo/rdb/pgsql_rdb.php',
        'swap\pgsql_rdb_conn'          => 'tech/repo/rdb/pgsql_rdb.php',
        'swap\pgsql_rdb_result'        => 'tech/repo/rdb/pgsql_rdb.php',
        'swap\sqlite_rdb_node'         => 'tech/repo/rdb/sqlite_rdb.php',
        'swap\sqlite_master_rdb_node'  => 'tech/repo/rdb/sqlite_rdb.php',
        'swap\sqlite_slave_rdb_node'   => 'tech/repo/rdb/sqlite_rdb.php',
        'swap\sqlite_rdb_conn'         => 'tech/repo/rdb/sqlite_rdb.php',
        'swap\sqlite_rdb_result'       => 'tech/repo/rdb/sqlite_rdb.php',
